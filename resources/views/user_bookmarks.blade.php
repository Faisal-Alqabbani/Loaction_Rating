                ...
                <div class="flex-auto p-6">
                    ...
                    <div class="flex space-x-3 mb-4 text-sm font-medium mt-5">
                        <div class="flex-auto flex space-x-3">
                            <a href="{{ route('place.show', [$place->id, $place->slug]) }}" class="w-15 h-8 flex items-center justify-center rounded-md border border-gray-300 p-4 hover:bg-gray-100">عرض</a>
                        </div>
                    </div>
                </div>
            </div>
