<x-app-layout>
    ...
    <div class="py-12">
        @if(!$places->count())
            <div class='text-blue-900 px-6 rounded relative bg-gray-200 max-w-7xl mx-auto'>
                <h2 class="inline-block align-middle mr-8">
                                      لايوجد مواقع ضمن هذا الصنف
                </h2>
            </div>
        @endif
        <div class='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4'>
            <div>
                ...
                <div class="flex mb-5 bg-white">
                   <div class="flex-none w-48 h-100 object-cover relative">
